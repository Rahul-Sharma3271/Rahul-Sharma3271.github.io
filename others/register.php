				...
				<div id="a">
					<div id="b">
						<form action="registerdb.php" method="POST" id="f">
							<br><br><br>
							<h1><img src="icons/rregister.png" class="float-left" width="150px" height="100px">
								<!-- Register -->
							</h1>
							Username:&nbsp;<input class="input-lg" type="text" name="uname"
								placeholder="Enter username"><br><br><br><br>
